 ...
 */
public class PrisaoMagica extends Habilidade {
    
    // Constantes do nome, dano e gasto da magia.
    private static final String NOME = "Prisão Mágica";
    private static final String DESCRICAO = "Deixa o alvo paralizado, fazendo com que possa ser inabilitado de usar um ataque por um período.";
    private static final int GASTODEMANA = 30;
    private static final int COOLDOWN = 30000;
    private static final int MULTIPLICADOR = 0;
    private final ImageIcon EFEITOESQUERDA = new ImageIcon(getClass().getResource("PrisaoMagica1.65.gif"));
    private final ImageIcon EFEITODIREITA = new ImageIcon(getClass().getResource("PrisaoMagica1.65.gif"));
    ...
    public ImageIcon getIcone(){
        return new ImageIcon(getClass().getResource("E_PrisaoMagicaG.png"));
    }
    ...
    @Override
    public CC getCc(){
        return new CC(2, 10000);
    }
    
    @Override
    public void mostraefeito(Personagem atacante, Tela tela) {
        tela.mostraEfeito(atacante, 1, this, 1650);
    }
}
